...
namespace BookStore.Data.Migrations
{
    ...
    [Migration("20240411052748_SeedDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineBookstoreManagementSystem.Infrastructure.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e2c227a0-50cc-4e66-a428-9237016a296a",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAELE8ReVwzfrDrIXx3IngwfqH0aKBDsim8BDRh1veAG2svb0R57GrJiwVqEYx88cTSw==",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b8083c77-22b5-456b-8979-ffc7f743c9e1",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAENwZg8/WZxBa7FauZlpFFT73DZiVolF/A5fiuyL/ZvONJZUYy90v2817QqGtQMQmvA==",
                            PhoneNumberConfirmed = false,
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("BookStore.Infrastructure.Data.Models.Book", b =>
                {
                    ...
                    b.HasOne("OnlineBookstoreManagementSystem.Infrastructure.Data.Models.ApplicationUser", "Buyer")
                        .WithMany()
            ...
            modelBuilder.Entity("BookStore.Infrastructure.Data.Models.Seller", b =>
                {
                    b.HasOne("OnlineBookstoreManagementSystem.Infrastructure.Data.Models.ApplicationUser", "User")
                        .WithMany()
